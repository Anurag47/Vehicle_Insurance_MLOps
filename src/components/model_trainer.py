...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            logging.info("Splitting the train and test numpy data into features and target variables")
            ...
            logging.info("Metric Calculation done.")
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            logging.info("train-test numpy data loaded")
            ...
            if metric_artifact.accuracy_score < self.model_trainer_config.expected_accuracy:
                logging.info("No model found with score above the given threshold score")
                raise Exception("No model found with score above the given threshold score")

            # Save the final model object that includes both preprocessing and the trained model
            logging.info("Saving model object that includes both preprocessing and the trained model")
            ...
            with open(self.model_trainer_config.metric_file_path, "w") as metric_file:
                json.dump(asdict(metric_artifact), metric_file, indent=4)
